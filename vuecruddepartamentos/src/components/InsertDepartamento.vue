<template>
  <div class="insert-container">
    ...
    <h1 class="titulo-insert">🌠 Insertar Departamento</h1>

    <form class="form-insert" @submit.prevent="submitForm()">
      ...
      <button type="submit" class="btn-submit">✨ Insertar Departamento</button>
    </form>
  </div>
</template>
...
export default {
  ...
  methods: {
    submitForm() {
      ...
      this.insertarDepartamento(nuevoDepartamento);
    },
    insertarDepartamento(nuevoDepartamento) {
      service.setDepartamento(nuevoDepartamento).then(() => {
